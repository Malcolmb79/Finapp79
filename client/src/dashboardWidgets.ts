import { ArrowLeftRight, CreditCard, Landmark, PieChart, PiggyBank, Receipt, Target, TrendingUp, type LucideIcon } from "lucide-react";
import type { WidgetMode, WidgetSize } from "./components/dashboard/SortableCard.js";

export const WIDGET_IDS = ["netWorth", "accounts", "cashflow", "transactions", "category", "budgets", "debts", "savings"] as const;
